  ...
  return (
    <>
      ...
      <section className='About_sec2'>
        <div className="head1">
          <h1 className='main'>BIOGRAPHY</h1>
        </div>
        <div className="text">
          <div className="text1">
            <h1 className='main-text container'>
              Seyi Adisa is a distinguished leader and passionate advocate for the development of individuals and communities across Africa.
            </h1>
            <div className="text1-img"></div>
          </div>

          <p>
            With a deep commitment to promoting good governance, Seyi has dedicated his career to building leaders and fostering active citizenship throughout the continent. His extensive experience in both the executive and legislative branches of government over the past 12 years equips him with a pragmatic approach to solving complex developmental challenges.
            ...
            During his tenure as a member of the Oyo State House of Assembly, representing the Afijio State Constituency from June 2019 to June 2023, Seyi chaired the House Committee on Foreign Relations. He focused on addressing youth unemployment through legislative efforts, sponsoring bills such as the Enterprise and Employability Trust Fund Bill, and raising motions to upgrade technical colleges and create technology parks.
            <div className='abtpic'></div>
            His initiatives, including the Technical & Vocational Education Training (TVET) program and the IITA Agribusiness program, empowered over 1,000 youth. Additionally, he introduced the John Maxwell iLead leadership development program to 17 public secondary schools in his constituency, impacting more than 3,500 students.
        ...
        <div className="vision">
          <h1>Philosophy and Vision</h1>
          <p>Seyi holds a profound belief that governance is both a privilege and a sacred duty. He views his role in government as an opportunity to serve God by creating positive impacts for the benefit of the people. Seyi is convinced that the challenges faced by the populace are intrinsically the challenges of the leader. He emphasizes that a leader must leverage their resourcefulness to effectively manage limited resources, ensuring they are utilized for the greater good of the community.

Furthermore, Seyi advocates for active citizen participation in governance. He believes that meaningful progress can only be achieved when the people engage in the governance process, contributing their voices and efforts rather than relying solely on leadership. His vision is to foster a collaborative environment where leaders and citizens work together to address societal issues, driving sustainable development and inclusive growth across Africa.</p>
        </div>
      </section>
